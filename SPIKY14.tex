...
\ref{fig:App_Fig1_PSTH_ES}

\begin{figure}
    \includegraphics[width=85mm]{App_Fig1_PSTH_ES.eps}
    \caption{\abb\label{fig:App_Fig1_PSTH_ES} Comparison of PSTH and event synchronization. \citep{QuianQuiroga02b} XXXXX}
\end{figure}
...
\begin{figure}
    ...
    \caption{\abb\label{fig:App_Fig2-SPIKE-Illustration} SPIKE-distance. Illustration of the local
...
\end{equation}
%
and analogously for $t_{\mathrm {F}}^{(1)}$, $t_{\mathrm {P}}^{(2)}$, and $t_{\mathrm {F}}^{(2)}$  (see Fig. \ref{fig:App_Fig2-SPIKE-Illustration}). For each spike train separately a locally weighted average is employed such that the differences for the closer spike dominate; the weighting factors depend on
%
